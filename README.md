...
### 🖼 Lightbox & EXIF
Full-screen lightbox with automatic EXIF extraction. Concept, idea and any memo notes with Markdown support related to projects and photos.

![Lightbox](./screenshots/screenshot-notes.webp)

### 🌐 Public Portfolio
One-click public portfolio at `/p/your-username`. Share your work with a clean, distraction-free URL.

![Portfolio](./screenshots/screenshot-portfolio.webp)
...
### 🖼 라이트박스 & EXIF
전체 화면 라이트박스와 자동 EXIF 추출. 사진과 연계된 마크다운 노트(컨셉, 메모, 리서치 등 모든 아이디어를 기록) 지원.

### 🌐 퍼블릭 포트폴리오
`/p/유저명` 주소로 깔끔한 포트폴리오 공개
