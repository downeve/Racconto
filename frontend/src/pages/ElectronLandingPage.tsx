            ...
            <div className="mt-6">
              ...
              <div className="mt-4 space-y-2">
                ...
                >
                  ...
                  <span className="text-menu text-stone-700">{t('auth.google', 'Google로 로그인')}</span>
                </button>
                ...
                >
                  ...
                  <span className="text-menu">{t('auth.apple', 'Apple로 로그인')}</span>
                </button>
                ...
                >
                  ...
                  <span className="text-menu text-white">{t('auth.naver', '네이버로 로그인')}</span>
                </button>
              </div>
            </div>
