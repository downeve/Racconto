    ...
    setSidebarContent(
      <div className="p-4">
        ...
        <div className="mb-4 flex">
          <label className={`flex-1 cursor-pointer t-caption px-2 py-2 inline-flex items-center justify-center gap-1.5 bg-edit-ink text-edit-paper hover:bg-edit-ink/85 rounded-l-[1px] border-r border-edit-paper/20 transition-colors ${uploading ? 'opacity-60 cursor-not-allowed' : ''}`}>
            {uploading
          ...
          <label className={`flex-1 cursor-pointer t-caption px-2 py-2 inline-flex items-center justify-center gap-1.5 bg-edit-ink text-edit-paper hover:bg-edit-ink/85 rounded-r-[1px] transition-colors ${uploading ? 'opacity-60 cursor-not-allowed' : ''}`}>
            {uploading
        ...
        <div className="my-3">
          <button
            ...
            className={`w-full px-3 py-2 text-left t-caption inline-flex items-center justify-between rounded-[1px] transition-colors ${
              selectionMode
        ...
        <div className="mb-4 mt-3">
          <div className="flex items-center justify-between mb-1.5">
            ...
            <button onClick={handleClearRatings} className="t-caption text-edit-faint hover:text-edit-danger transition-colors">{t('common.reset')}</button>
          </div>
          {[5, 4, 3, 2, 1].map(star => (
        ...
        <div className="mb-2">
          <div className="flex items-center justify-between mb-1.5">
            ...
            <button onClick={handleClearColorLabels} className="t-caption text-edit-faint hover:text-edit-danger transition-colors">{t('common.reset')}</button>
          </div>
