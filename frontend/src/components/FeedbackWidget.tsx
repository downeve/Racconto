  ...
  return (
    <>
      <button
        ...
        className={`fixed right-8 ${isShifted ? 'bottom-[78px]' : 'bottom-6'} rounded-full bg-ink text-canvas p-3 shadow hover:bg-ink-2 transition-all duration-300 z-50 flex items-center justify-center w-10 h-10`}
