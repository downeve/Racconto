  ...
  return (
    ...
    <ReactMarkdown
      ...
      components={{
        ...
        h1:     ({ children }) => <h1 className={`text-xl font-bold mb-2 ${headingColor}`}>{children}</h1>,
        h2:     ({ children }) => <h2 className={`text-lg font-semibold mb-1.5 ${headingColor}`}>{children}</h2>,
